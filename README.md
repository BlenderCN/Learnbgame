...
# [Unreal项目](HoudiniEngineForUnreal)
...
###  :memo: [ImmunemaG](ImmunemaG.md)————他山之石
...
从原子出发，有[元素周期表](https://ptable.com/#Properties),往前，有原子核和电子组成的电子云，往后，则是原子通过[化学方程式]()实现构成分子的三维结构，以[smiles](https://github.com/BlenderCN/Learnbgame/blob/master/poqbdb/%E5%88%86%E5%AD%90.md)格式构建分子三维结构，这是个微观世界，
