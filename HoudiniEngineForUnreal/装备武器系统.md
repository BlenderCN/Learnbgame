...
#### 🗡剑
*	TakeOffHelper(AC_Inventory)	Can be Modification(AC_Inventory) 	TakeItemOff(BP_ArmorHelper)		Add New Item F(BP_ArmorHelper)		Get Visibility 1(WB_InventorySlot)		Construct(WB_InventoryToolTip)		Update(WB_InventoryToolTip)		Get Text Block 4 Text 0(WB_InventoryToolTip)		Get Visibility 2(WB_InventoryToolTip)		HoldButtonSpell(AC_Skills)	Toggle Weapon Slots(AC_Inventory)
*	
