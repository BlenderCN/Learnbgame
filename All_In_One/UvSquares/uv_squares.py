...
class UV_PT_UvSquaresPanel(bpy.types.Panel):
	...
	def draw(self, context):
		...
		col.operator(UV_OT_SnapToAxisWithEqual.bl_idname, text="Snap with Equal Distance", icon = "ARROW_LEFTRIGHT")
		...
		col.operator(UV_OT_JoinFaces.bl_idname, text="Snap to Closest Unselected", icon = "SNAP_INCREMENT")
		row = layout.row()
