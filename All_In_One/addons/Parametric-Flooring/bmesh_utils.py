...
class BmeshEdit():
    ...
    @staticmethod
    def bevel(context, o, offset, offset_type=0, segments=1, profile=0.5, vertex_only=False, clamp_overlap=True,
              material=-1, use_selection=True):
        """
    ...
    @staticmethod
    def bissect(context, o, plane_co, plane_no, dist=0.001, use_snap_center=False, clear_outer=True, clear_inner=False):
