...
class WM_MT_splash(Menu):
    ...
    def draw(self, context):
        ...
        if found_recent:
            ...
            ).url = "https://opencv-laboratory.readthedocs.io/en/latest/"
            col2.operator(
                "wm.url_open", text="GitHub", icon='URL',
            ).url = "https://github.com/feler404/ocvl-addon"
            col2.operator(
                "wm.url_open", text="OCVL Website", icon='URL',
            ).url = "https://www.ocvl.teredo.tech/"
            col2.operator(
                "wm.url_open", text="Issues", icon='URL',
            ).url = "https://github.com/feler404/ocvl-addon/issues"
        ...
        col2 = split.column()
        col2.operator(
            "wm.url_open", text="Open CV", icon='URL',
        ).url = "https://opencv.org/"
        col2.operator(
            "wm.url_open", text="Blender", icon='URL'
        ).url = "https://www.blender.org/"
        col2.operator(
            "wm.url_open", text="Python", icon='URL'
