...
class Tree(object):
    ...
    def make(self):
        ...
        bpy.context.scene.collection.objects.link(self.tree_obj)
    ...
    def create_branches(self):
        ...
        bpy.context.scene.collection.objects.link(branches_obj)
    ...
    def create_leaf_mesh(self):
        ...
        if blossom_index > 0:
            ...
            bpy.context.scene.collection.objects.link(blossom_obj)
        ...
        for seg_ind in range(start, curve_res + 1):
            ...
            if self.param.curve_v[depth] < 0:
                ...
                if seg_ind == start:
                    ...
                    stem.curve.bezier_points.add(count=1)
                    new_point = stem.curve.bezier_points[-1]
