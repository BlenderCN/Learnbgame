...
class LEARNBGAME_SPECIES_PLANT_TREE(bpy.types.Panel):
    ...
    bl_parent_id = "LEARNBGAME_SPECIES_PLANT"
...
class TreeGenCustomise_PT_Panel(bpy.types.Panel):
    ...
    bl_parent_id = "LEARNBGAME_SPECIES_PLANT_TREE"
    ...
    def draw(self, context):
        ...
        def label_row(label, prop, checkbox=False, dropdown=False, container=None):
            ...
            if dropdown:
                ...
                cont = col.split(factor=.5, align=True)
