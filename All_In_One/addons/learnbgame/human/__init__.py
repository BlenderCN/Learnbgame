...
human_info = {"version":(1, 7, 2)}

mblab_humanoid = humanoid.Humanoid(human_info["version"])
...
def start_lab_session():
    ...
    if is_obj[0] == "NO_OBJ":
        ...
        obj["manuellab_vers"] = human_info["version"]
...
class VIEW3D_PT_tools_ManuelbastioniLAB(bpy.types.Panel):
    ...
    bl_label = "Human"# {0}.{1}.{2}".format(human_info["version"][0], human_info["version"][1], bl_info["version"][2])
    bl_idname = "OBJECT_PT_characters01"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    #bl_context = 'objectmode'
    bl_category = "Learnbgame"
    bl_parent_id = "LEARNBGAME_SPECIES_ANIMAL"
