...
class HOPS_OT_SelectedToSelection(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.data.objects[second_obj.name].select_set(state=False)
        ...
        for face in selected_faces:
            ...
            bpy.data.objects[second_obj.name].select_set(state=True)
        ...
        bpy.data.objects["Dummy"].select_set(state=True)
        ...
        bpy.data.objects[second_obj.name].select_set(state=True)
        bpy.data.objects[ref_obj.name].select_set(state=True)
