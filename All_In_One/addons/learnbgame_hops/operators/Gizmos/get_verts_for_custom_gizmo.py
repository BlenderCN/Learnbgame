#Just open this file inside blender's text editor,
#and with an object selected, run the script.
#the vertices of the triangles of the object will
#be written to the `custom_gizmo_shapes.py` file.

#IMPORTANT!!! for the custom shape to be exported
#properly, you must triangulate the object mesh first!
