...
CLASSES = [
OBJECT_PT_stereo_camera,
OBJECT_OT_set_center_render_camera,
OBJECT_OT_set_right_render_camera,
OBJECT_OT_set_stereo_camera,
OBJECT_OT_create_left_right_scene,
NODE_EDITOR_PT_preset,
OBJECT_OT_add_stereo_node_preset,
]
