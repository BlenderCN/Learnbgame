...
# a small modification of blender addon `io_import_images_as_planes`
# import images (with alpha channel) as grid meshes
# zzj

bl_info = {
    "name": "Import Images as Grid Meshes",
    "author": "Florian Meyer (tstscr), mont29, matali",
    "version": (2, 0, 5),
    "blender": (2, 76, 1),
    "location": "File > Import > Images as Grids or Add > Mesh > Images as Grids",
...
class IMPORT_OT_image_to_grid(Operator, AddObjectHelper):
    ...
    def import_images(self, context):
        ...
        # udpate positions for projection view
    ...
    def create_image_plane(self, context, material):
        ...
        subdivision_step = 20
        bpy.ops.mesh.primitive_grid_add('INVOKE_REGION_WIN', x_subdivisions=subdivision_step, y_subdivisions=subdivision_step)
        ...
        for f in bm.faces:
            for l in f.loops:
                ...
                luv.uv[0] = (l.vert.co.xy[0]/x + 0.5)
                luv.uv[1] = (l.vert.co.xy[1]+0.5)
