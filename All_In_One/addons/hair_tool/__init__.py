...
#TODO: add more frequency to braids... ? or maybe when curve is scaled it dosen't work the way it should
#DONE: Apply curve rotation when aligning titl to prevetn weird rotaton problems
#TODO: add flatten for braids: it it is more squishy
...
bl_info = {
    ...
    "version": (1, 9, 2),
    "warning": "",
    "wiki_url": "https://bartoszstyperek.wordpress.com/2017/07/29/hair-tool-blender-addon/",
