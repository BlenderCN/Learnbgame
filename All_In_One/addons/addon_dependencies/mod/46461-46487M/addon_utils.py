...
def paths():
    ...
    # for wip or not yet submitted addons (use those ones at your own risk)
    # if folder addons_sandbox/ exists, scripts in there will be loaded too
    addon_paths += _bpy.utils.script_paths("addons_sandbox")
    return addon_paths
...
def reset_all(reload_scripts=False):
    ...
    # this mod in order dependencies can load. can act whatever the addon folder is
