...
class Humanoid:
    ...
    def init_database(self,obj,character_identifier,rigging_type):
        ...
        lab_logger.info("Found the humanoid: {0}".format(character_identifier))
        ...
        self.restposes_path = os.path.join(self.data_path,self.data_path,"poses","rest_poses")
    ...
    def load_character(self, data_source, reset_string = "nothing", reset_unassigned=True, mix=False, update_mode = "update_all"):
        ...
        if "manuellab_vers" in charac_data:
            ...
            lab_logger.info("No lab version specified in {0}".format(log_msg_type))
        ...
        if "metaproperties" in charac_data:
            ...
            lab_logger.info("No metaproperties data in  {0}".format(log_msg_type))
            meta_data = {}
