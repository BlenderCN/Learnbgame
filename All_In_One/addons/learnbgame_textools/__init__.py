...
class PANEL_PT_UNITS(bpy.types.Panel):
	bl_label = " "
			...
			if bpy.context.active_object in bpy.context.selected_objects:
				if bpy.context.active_object.type == 'MESH':
					...
					if not bpy.context.object.data.uv_layers:
						...
						row.operator(op_uv_channel_add.op.bl_idname, text="Add", icon = 'ZOOM_IN')
					else:
						# c = split.column(align=True)
						# row = c.row(align=True)
						group = row.row(align=True)
						group.prop(context.scene.texToolsSettings, "uv_channel", text="")
						group.operator(op_uv_channel_add.op.bl_idname, text="", icon = 'ZOOM_IN')
...
class PANEL_PT_LAYOUT(bpy.types.Panel):
	bl_label = " "
	bl_space_type = 'IMAGE_EDITOR'
	bl_region_type = 'UI'
	bl_category = "TexTools"
...
class PANEL_PT_BAKE(bpy.types.Panel):
	bl_label = " "
	bl_space_type = 'IMAGE_EDITOR'
	bl_region_type = 'UI'
	bl_category = "TexTools"
...
class OP_COLOR_MT_DROPDOWN_IO(bpy.types.Menu):
...
class OP_COLOR_MT_DROPDOWN_CONVERT_FROM(bpy.types.Menu):
...
class OP_COLOR_PT_DROPDOWN_CONVERT_TO(bpy.types.Menu):
...
class PANEL_PT_COLORS(bpy.types.Panel):
	bl_label = " "
	bl_space_type = 'IMAGE_EDITOR'
	bl_region_type = 'UI'
	bl_category = "TexTools"
	...
	def draw(self, context):
		...
		row.menu(OP_COLOR_MT_DROPDOWN_IO.bl_idname, text='', icon='COLOR')
		...
		row = col.row(align=True)
		row.menu(OP_COLOR_MT_DROPDOWN_CONVERT_FROM.bl_idname)#, icon='IMPORT'
		row.menu(OP_COLOR_PT_DROPDOWN_CONVERT_TO.bl_idname,)# icon='EXPORT'
...
class PANEL_PT_MESHTEXTURE(bpy.types.Panel):
	bl_label = " "
	bl_space_type = 'IMAGE_EDITOR'
	bl_region_type = 'UI'
	bl_category = "TexTools"
...
def menu_IMAGE_uvs(self, context):
	...
	layout.menu(SUBMENU_PT_ALIGN.bl_idname)

class SUBMENU_PT_ALIGN(bpy.types.Menu):
	bl_label="Align"
...
classes = (
	...
	PANEL_PT_LAYOUT,
	PANEL_PT_BAKE,
	OP_COLOR_MT_DROPDOWN_IO,
	OP_COLOR_MT_DROPDOWN_CONVERT_FROM,
	OP_COLOR_PT_DROPDOWN_CONVERT_TO,
	op_enable_cycles,
	PANEL_PT_COLORS,
	PANEL_PT_MESHTEXTURE,
	)
...
def register():
	...
	op_align.register()
	op_bake.register()
	op_bake_explode.register()
	op_bake_organize_names.register()
	op_texture_preview.register()
	op_color_assign.register()
	op_color_clear.register()
	op_color_convert_texture.register()
	op_color_convert_vertex_colors.register()
	op_edge_split_bevel.register()
	op_color_from_elements.register()
	op_color_from_materials.register()
	op_color_from_directions.register()
	op_color_io_export.register()
	op_color_io_import.register()
	op_color_select.register()
	op_island_align_edge.register()
	op_island_align_size.register()
	op_island_align_sort.register()
	op_island_align_world.register()
	op_island_mirror.register()
	op_island_rotate_90.register()
	op_island_straighten_edge_loops.register()
	op_rectify.register()
	op_select_islands_identical.register()
	op_select_islands_outline.register()
	op_select_islands_overlap.register()
	op_select_islands_flipped.register()
	op_smoothing_uv_islands.register()
	op_meshtex_create.register()
	op_meshtex_wrap.register()
	op_meshtex_trim.register()
	op_meshtex_trim_collapse.register()
	op_meshtex_pattern.register()
	op_texel_checker_map.register()
	op_texel_density_get.register()
	op_texel_density_set.register()
	op_texture_reload_all.register()
	op_texture_save.register()
	op_texture_open.register()
	op_texture_select.register()
	op_texture_remove.register()
	op_unwrap_faces_iron.register()
	op_unwrap_edge_peel.register()
	op_uv_channel_add.register()
	op_uv_channel_swap.register()
	op_uv_crop.register()
	op_uv_fill.register()
	op_uv_resize.register()
	op_uv_size_get.register()
	...
	bpy.types.VIEW3D_MT_mesh_add.append(menu_INFO_MT_mesh_add)
	bpy.types.VIEW3D_MT_uv_map.append(menu_VIEW3D_MT_uv_map)
	bpy.types.VIEW3D_MT_object_context_menu.append(menu_VIEW3D_MT_object_specials)
...
def unregister():
	...
	op_align.unregister()
	op_bake.unregister()
	op_bake_explode.unregister()
	op_bake_organize_names.unregister()
	op_texture_preview.unregister()
	op_color_assign.unregister()
	op_color_clear.unregister()
	op_color_convert_texture.unregister()
	op_color_convert_vertex_colors.unregister()
	op_edge_split_bevel.unregister()
	op_color_from_elements.unregister()
	op_color_from_materials.unregister()
	op_color_from_directions.unregister()
	op_color_io_export.unregister()
	op_color_io_import.unregister()
	op_color_select.unregister()
	op_island_align_edge.unregister()
	op_island_align_size.unregister()
	op_island_align_sort.unregister()
	op_island_align_world.unregister()
	op_island_mirror.unregister()
	op_island_rotate_90.unregister()
	op_island_straighten_edge_loops.unregister()
	op_rectify.unregister()
	op_select_islands_identical.unregister()
	op_select_islands_outline.unregister()
	op_select_islands_overlap.unregister()
	op_select_islands_flipped.unregister()
	op_smoothing_uv_islands.unregister()
	op_meshtex_create.unregister()
	op_meshtex_wrap.unregister()
	op_meshtex_trim.unregister()
	op_meshtex_trim_collapse.unregister()
	op_meshtex_pattern.unregister()
	op_texel_checker_map.unregister()
	op_texel_density_get.unregister()
	op_texel_density_set.unregister()
	op_texture_reload_all.unregister()
	op_texture_save.unregister()
	op_texture_open.unregister()
	op_texture_select.unregister()
	op_texture_remove.unregister()
	op_unwrap_faces_iron.unregister()
	op_unwrap_edge_peel.unregister()
	op_uv_channel_add.unregister()
	op_uv_channel_swap.unregister()
	op_uv_crop.unregister()
	op_uv_fill.unregister()
	op_uv_resize.unregister()
	op_uv_size_get.unregister()
	...
	bpy.types.VIEW3D_MT_mesh_add.remove(menu_INFO_MT_mesh_add)
	bpy.types.VIEW3D_MT_uv_map.remove(menu_VIEW3D_MT_uv_map)
	bpy.types.VIEW3D_MT_object_context_menu.remove(menu_VIEW3D_MT_object_specials)
