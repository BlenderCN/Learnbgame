This program,
Suicidator City Generator (SCG) Full
is copyright Arnaud Couturier.
It allows you to quickly create 3d cities.


Licence:
The copy of Suicidator City Generator Full you purchased can be used by only you.
You cannot redistribute it.
You are not allowed to reverse-engineer the code. 
...
(1) Install Blender 2.62
Get it from http://www.blender.org/download/get-blender/
SCG will probably not run with previous versions of Blender.
SCG may work with Blender versions above 2.62, but it's not guaranteed.
Check the SCG website for SCG compatibility updates as new version of Blender come out.
