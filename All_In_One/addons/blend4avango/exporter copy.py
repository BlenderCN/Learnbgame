...
def process_mesh_boundings(mesh_data, mesh, bounding_data):
    if (mesh.b4a_override_boundings):
        bounding_box = mesh.b4a_boundings
        ...
        dct = mesh_data["b4a_bounding_box"] = OrderedDict()
        ...
        mesh_data["b4a_bounding_sphere_radius"] = round_num(srad, 3)
        mesh_data["b4a_bounding_cylinder_radius"] = round_num(crad, 3)

        bounding_center = round_iterable([x_cen, z_cen, -y_cen], 3)
        mesh_data["b4a_bounding_sphere_center"] = bounding_center
        mesh_data["b4a_bounding_cylinder_center"] = bounding_center

        # calculate ellipsoid boundings
        sq3 = math.sqrt(3)
        mesh_data["b4a_bounding_ellipsoid_axes"] = round_iterable([sq3 * x_width, sq3 * z_width, sq3 * y_width], 3)
        mesh_data["b4a_bounding_ellipsoid_center"] = bounding_center
        ...
        mesh_data["b4a_bounding_sphere_radius"] \
                = round_num(bounding_data["srad"], 3)
        mesh_data["b4a_bounding_cylinder_radius"] \
                = round_num(bounding_data["crad"], 3)
        mesh_data["b4a_bounding_sphere_center"] = round_iterable([
            bounding_data["scen_x"],
            bounding_data["scen_y"],
            bounding_data["scen_z"]
        ], 3)
        mesh_data["b4a_bounding_cylinder_center"] = round_iterable([
            bounding_data["ccen_x"],
            bounding_data["ccen_y"],
            bounding_data["ccen_z"]
        ], 3)

        mesh_data["b4a_bounding_ellipsoid_axes"] = round_iterable([
            bounding_data["eaxis_x"],
            bounding_data["eaxis_y"],
            bounding_data["eaxis_z"]
        ], 3)
        mesh_data["b4a_bounding_ellipsoid_center"] = round_iterable([
