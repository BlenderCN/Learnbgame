...
from .list_utils import add_objs, check_selected_objs, remove_obj, clear_objs, select_objs, hide_objs, get_hi_res_prop


class DATA_UL_jet_hi_res_list(UIList):
    """
    List to contain objects (only meshes)
    """
    bl_idname = "DATA_UL_jet_list_hi_res"
...
class DATA_OT_jet_hi_res_list_add(Operator):
    """
    Operator to add objects to the list
    """
    bl_idname = "hi_res_obj_list_add.btn"
    ...
    def execute(self, context):
        prop = get_hi_res_prop(context)
        add_objs(prop, context)
        return {'FINISHED'}


class DATA_OT_jet_hi_res_list_remove(Operator):
    """
    Operator to remove objects from the list
    """
    bl_idname = "hi_res_obj_list_remove.btn"
...
class DATA_OT_jet_hi_res_list_clear(Operator):
    """
    Operator to remove all the objects from the list
    """
    bl_idname = "hi_res_obj_list_clear.btn"
    bl_label = "Clear list"
...
class DATA_OT_jet_hi_res_list_select(Operator):
    """
    Operator to select/deselect objects from the list
    """
    bl_idname = "hi_res_obj_list_select.btn"
...
class DATA_OT_jet_hi_res_list_hide(Operator):
    """
    Operator to show/hide objects from the list
    """
    bl_idname = "hi_res_obj_list_hide.btn"
