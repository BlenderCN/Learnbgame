...
class DomainWhitewaterProperties(bpy.types.PropertyGroup):
    ...
    def register(cls):
        ...
        cls.generate_whitewater_motion_blur_data = BoolProperty(
        ...
        cls.obstacle_influence_base_level = FloatProperty(
        ...
        cls.obstacle_influence_decay_rate = FloatProperty(
