...
class DTMViewerRenderContext:
    ...
    def __init__(self, dtm_img, dtm_resolution, dtm_stars, dtm_mist, dtm_texture=None, dtm_flyover=None):
        self.__img = dtm_img
...
def load(operator, context, filepath, scale, bin_mode, color_pattern, flyover_pattern,
         texture_location, cropVars, resolution, stars, mist, render, animation):
    ...
    #Create the path for our flyover.
    newScene.create_flyover_path()
