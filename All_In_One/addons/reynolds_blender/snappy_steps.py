...
class SnappyStepsOperator(bpy.types.Operator):
    bl_idname = "reynolds.of_snappy_steps_op"
    bl_label = "Steps to Run"
...
def register():
    ...
    set_scene_attrs('snappy_steps.yaml')

def unregister():
    unregister_classes(__name__)
    del_scene_attrs('snappy_steps.yaml')
