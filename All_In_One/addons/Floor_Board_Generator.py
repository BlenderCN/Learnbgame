...
def updateMesh(self, context):
    ...
    #set shading to smooth and autosmooth
...
bpy.types.Object.length = FloatProperty(name="Floor Size X",
...
bpy.types.Object.width = FloatProperty(name="Y",
...
bpy.types.Object.planklength = FloatProperty(name="Plank Size X",
...
bpy.types.Object.planklengthvar = FloatProperty(name="Variation X",
...
bpy.types.Object.plankwidth = FloatProperty(name="Y",
...
bpy.types.Object.plankwidthvar = FloatProperty(name="Y",
...
bpy.types.Object.longgap = FloatProperty(name="Gap Size X",
...
bpy.types.Object.shortgap = FloatProperty(name="Y",
...
bpy.types.Object.thickness = FloatProperty(name="Plank Thickness",
...
bpy.types.Object.originx = FloatProperty(name="Origin Offset X",
...
bpy.types.Object.originy = FloatProperty(name="Y",
...
bpy.types.Object.randrotx = FloatProperty(name="Rotation X",
...
bpy.types.Object.randroty = FloatProperty(name="Rotation Y",
...
bpy.types.Object.randrotz = FloatProperty(name="Rotation Z",
...
bpy.types.Object.uvscalex = FloatProperty(name="Scale UV X",
...
bpy.types.Object.uvscaley = FloatProperty(name="Y",
...
class FBGPanelMainOffset(bpy.types.Panel):
    ...
    def poll(cls, context):
        o = context.object
        return ((context.mode == 'OBJECT') and ('reg' in o) and (o['reg'] == 'FloorBoards'))
...
class FBGPanelPlanksDim(bpy.types.Panel):
    bl_idname = "FLOOR_BOARD_GEN_PT_planks_dimensions"
    bl_label = "Plank Dimensions"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Floorgenerator"
    ...
    def poll(cls, context):
        o = context.object
        return ((context.active_object != None) and (context.mode == 'OBJECT') and ('reg' in o) and (o['reg'] == 'FloorBoards'))
    ...
    def draw(self, context):
        ...
        if o.pattern == 'Regular':
            col = flow.column(align=True)
            col.prop(o, 'planklength')
            col.prop(o, 'plankwidth')
            col = flow.column(align=True)
            col.prop(o, 'planklengthvar')
            col.prop(o, 'plankwidthvar')
        
        if o.pattern == 'Herringbone':
            col = flow.column(align=True)
            col.prop(o, 'planklength')
            col.prop(o, 'plankwidth')
        
        if o.pattern == 'Square':
            layout.prop(o, 'planklength')
            layout.prop(o, 'nsquare')
            layout.prop(o, 'border')
        
        if o.pattern == 'Versaille':
            layout.prop(o, 'planklength')
        
        layout.prop(o, 'thickness')
        ...
        if o.pattern == 'Regular':
            layout.prop(o, 'offset')
            layout.prop(o, 'randomoffset')
            layout.prop(o, 'minoffset')
        
        if o.pattern == 'Versaille':
            layout.prop(o, 'borderswitch')
            
class FBGPanelRandomness(bpy.types.Panel):
    bl_idname = "FLOOR_BOARD_GEN_PT_randomness"
    bl_parent_id = "FLOOR_BOARD_GEN_PT_planks_dimensions"
    bl_label = "Randomness"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Floorgenerator"
    ...
    def draw(self, context):
        ...
        col = flow.column(align=True)
        col.prop(o, 'hollowlong')
        col.prop(o, 'hollowshort')
        
        layout.prop(o, 'twist')
        layout.prop(o, 'randomthickness')
        layout.prop(o, 'randomseed')
                   
class FBGPanelMiscellaneous(bpy.types.Panel):
    bl_idname = "FLOOR_BOARD_GEN_PT_miscellaneous"
    ...
    def draw(self, context):
        ...
        layout.prop(o, 'usefloorplan')
        if o.usefloorplan:
            layout.prop(o, 'floorplan')
        layout.prop(o, 'randomuv')
        layout.prop(o, 'uvrotation')
        col = flow.column(align=True)
        col.prop(o, 'uvscalex')
        col.prop(o, 'uvscaley')
        layout.prop(o, 'modify')
        if o.modify:
            layout.prop(o, 'bevel')
        layout.prop(o,'preservemats')
