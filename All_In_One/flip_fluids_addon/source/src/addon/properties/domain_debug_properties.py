...
class DomainDebugProperties(bpy.types.PropertyGroup):
    ...
    def register(cls):
        ...
        cls.display_domain_bounds = BoolProperty(
                name="Display Bounds",
        ...
        cls.domain_bounds_color = FloatVectorProperty(  
        ...
        cls.min_gradient_speed = FloatProperty(
        ...
        cls.max_gradient_speed = FloatProperty(
        ...
        cls.particle_draw_aabb = PointerProperty(
