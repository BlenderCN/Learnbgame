...
class DomainRenderProperties(bpy.types.PropertyGroup):
    ...
    def register(cls):
        ...
        cls.render_surface_motion_blur = BoolProperty(
        ...
        cls.surface_motion_blur_scale = FloatProperty(
                name="Scale",
        ...
        cls.render_whitewater_motion_blur = BoolProperty(
                name="Render Motion Blur",
        ...
        cls.whitewater_motion_blur_scale = FloatProperty(
                name="Scale",
