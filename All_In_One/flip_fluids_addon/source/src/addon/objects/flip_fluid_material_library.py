...
class FLIPFluidMaterialLibraryMaterial(bpy.types.PropertyGroup):
    @classmethod
    def register(cls):
        cls.name = StringProperty(default="")
        cls.description = StringProperty(default="")
        cls.path = StringProperty(default="")
        cls.type = EnumProperty(items=types.material_types, default="MATERIAL_TYPE_SURFACE")
        cls.icon_id = IntProperty(default=-1)
        cls.imported_icon_id = IntProperty(default=-1)
...
class FLIPFluidMaterialLibrary(bpy.types.PropertyGroup):
    @classmethod
    def register(cls):
        cls.library_path = StringProperty(default="")
        cls.material_list = CollectionProperty(type=FLIPFluidMaterialLibraryMaterial)
