...
def update_debug_grid_geometry(context):
    ...
    maxx = bbox.x + width - solid_width
    maxy = bbox.y + height - solid_width
    maxz = bbox.z + depth - solid_width
...
draw_simulation_voxel_handle_3d = None
...
def register():
    ...
    global draw_simulation_voxel_handle_3d
    draw_simulation_voxel_handle_3d = bpy.types.SpaceView3D.draw_handler_add(
            draw_simulation_voxel, (), 'WINDOW', 'POST_VIEW'
            )
...
def unregister():
    ...
    global draw_simulation_voxel_handle_3d
    if draw_simulation_voxel_handle_3d is not None:
        bpy.types.SpaceView3D.draw_handler_remove(draw_simulation_voxel_handle_3d, 'WINDOW')
