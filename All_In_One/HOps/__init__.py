...
bl_info = {
    "name": "Hard Ops 9",
    "description": "Hard Ops 9 - V8: Californium",
    ...
    "wiki_url": "https://masterxeon1001.com/2019/03/06/hard-ops-0098-release-notes/",
    "category": "3D View"}
...
from .operators.modifiers import simple_deform, triangulate, weighted_normal, wireframe, displace, subsurf, screw, lattice, decimate, Apply_modfiers, shrinkwrap, skin, cast, mask, hook
...
#    HOPS_PT_OptionsPanel,
    ...
    HOPS_GT_MirrorCustomShapeGizmoMod,
    HOPS_GT_MirrorCustomShapeGizmoSymm,
    HOPS_GT_MirrorCustomShapeGizmoBisect,
