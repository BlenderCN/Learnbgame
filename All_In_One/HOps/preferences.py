...
class HardOpsPreferences(bpy.types.AddonPreferences):
    ...
    sort_modifiers: BoolProperty(name="Sort modifier", default=True)
    sort_bevel_last: BoolProperty(name="Sort modifier", default=False)
    sort_bevel: BoolProperty(name="Sort modifier", default=True)
    sort_array: BoolProperty(name="Sort modifier", default=True)
    sort_mirror: BoolProperty(name="Sort modifier", default=True)
    sort_weighted_normal: BoolProperty(name="Sort modifier", default=True)
    sort_simple_deform: BoolProperty(name="Sort modifier", default=True)
    sort_triangulate: BoolProperty(name="Sort modifier", default=True)
    ...
    # helper_width: IntProperty(
    #     name="Helper width",
    #     description="Width of the helper in pixels (dpi factored)",
    #     min = 0,
    #     soft_min=150,
    #     soft_max=400,
    #     subtype="PIXEL",
    ...
    pie_bool_options: BoolProperty(
        ...
        default=True,
        description="Add Boolean Buttons to Pie Menu")
    ...
    def draw_drawing_tab(self, layout):
        ...
        row = box.row(align=True)
        row.prop(self, "Hops_hud_color", text="Hud Color")
        row = box.row(align=True)
        row.prop(self, "Hops_hud_text_color", text="Hud Text Color")
        row = box.row(align=True)
        row.prop(self, "Hops_hud_help_color", text="Hud Help Color")
    ...
    def draw_ui_tab(self, layout):
        ...
        row = layout.row()
        row.prop(self, "use_dpi_factoring")

        row = layout.row()
        row.prop(self, "use_helper_popup")

        row = layout.row()
        row.prop(self, "use_bevel_helper_popup")

        row = layout.row()
        row.prop(self, "use_kitops_popup")
        ...
        # row = layout.row()
        # row.label(text="Helper Width:")
        # row.prop(self, "helper_width")
