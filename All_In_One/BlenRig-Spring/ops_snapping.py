...
def set_prop_and_keyframe(obj, property_name, value):
    setattr(obj, property_name, value)
    obj.keyframe_insert(property_name)
...
class Operator_Arm_L_Snap_IK_FK(bpy.types.Operator):
    ...
    do_switch: BoolProperty(default=False)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_arm_L"], "ik_arm_L", 1)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_arm_L"], "ik_arm_L", 0)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_arm_R"], "ik_arm_R", 1)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_arm_R"], "ik_arm_R", 0)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_leg_L"], "ik_leg_L", 1)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_leg_L"], "ik_leg_L", 0)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_leg_R"], "ik_leg_R", 1)
...
#                    return {"CANCELLED"}
        ...
        if arm_data['rig_type'] == 'Biped':
            ...
            if self.do_switch:
                set_prop_and_keyframe(p_bones["properties_leg_R"], "ik_leg_R", 0)
