...
class CastellatedMeshOperator(bpy.types.Operator):
    bl_idname = "reynolds.of_cm_op"
    bl_label = "Castellated Mesh Controls"
...
def register():
    ...
    set_scene_attrs('castellated_mesh.yaml')

def unregister():
    unregister_classes(__name__)
    del_scene_attrs('castellated_mesh.yaml')
